 ...
 */
public class HisThreadAdapter extends BaseQuickAdapter<HisThreadResult.DataBean,BaseViewHolder>{
    private String headImageUrl;
    public HisThreadAdapter(int layoutResId, List<HisThreadResult.DataBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, HisThreadResult.DataBean item) {
        ...
        Glide.with(mContext).load(headImageUrl).error(R.drawable.icon_default_head).into(ivHead);
